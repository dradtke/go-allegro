...
const (
	...
	AUDIO_DEPTH_INT16    Depth = C.ALLEGRO_AUDIO_DEPTH_INT16
	AUDIO_DEPTH_INT24    Depth = C.ALLEGRO_AUDIO_DEPTH_INT24
	AUDIO_DEPTH_FLOAT32  Depth = C.ALLEGRO_AUDIO_DEPTH_FLOAT32
	AUDIO_DEPTH_UNSIGNED Depth = C.ALLEGRO_AUDIO_DEPTH_UNSIGNED
	AUDIO_DEPTH_UINT8    Depth = C.ALLEGRO_AUDIO_DEPTH_UINT8
	AUDIO_DEPTH_UINT16   Depth = C.ALLEGRO_AUDIO_DEPTH_UINT16
